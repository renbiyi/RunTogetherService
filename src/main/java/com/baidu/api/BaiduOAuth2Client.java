...
public class BaiduOAuth2Client {
    ...
    private String _getAuthorizationCode(String clientId, String redirectUri,
     ...
     */
    public BaiduOAuthToken getAccessTokenByAuthorizationCode(String code)
     ...
     */
    public BaiduOAuthToken getAccessTokenByClientCredentials(String scope)
            throws BaiduOAuthException {
        Map<String, String> param = new HashMap<String, String>();
     ...
     * @throws BaiduOAuthException OAuthException异常类
     */
    public BaiduOAuthToken getAccessTokenByRefreshToken(String refreshToken, String scope)
            throws BaiduOAuthException {
        Map<String, String> param = new HashMap<String, String>();
     ...
     * @throws BaiduOAuthException
     */
    public BaiduOAuthToken getAccessTokenByPasswordCredentials(String username, String password,
            String scope) throws BaiduOAuthException {
    ...
    private BaiduOAuthToken makeOAuthAccessToken(String url, Map<String, String> params)
            throws BaiduOAuthException {
