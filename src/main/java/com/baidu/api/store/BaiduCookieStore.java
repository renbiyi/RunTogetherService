...
public final class BaiduCookieStore extends BaiduStore {
     ...
     * 
     * @param clientId 应用id
     * @param request HttpServletRequest对象，用于获取cookie对象
     * @param response HttpServletResponse对象，用于添加cookie对象
     */
    public BaiduCookieStore(String clientId, HttpServletRequest request,
